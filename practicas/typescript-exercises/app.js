...
//Así se ve más claro
const a = 10; //para typescript este es tipo de dato "10" PORQUE NO LO PODEMOS CAMBIAR, ES UNA CONSTANTE
//let b; si lo dejas así se pone el tipo de dato ANY, significa "cualquier cosa"
let b = 10; //SI PUEDE CAMBIAR, por lo tanto le ponemos number
function name(msg) {
    console.log(msg);
}
(function () {
