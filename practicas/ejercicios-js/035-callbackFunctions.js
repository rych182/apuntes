...
findPostById(1,(err,post)=>{
  ...
  //si quiero mandar llamar al ID 2
  findPostById(2,(err,post)=>{
    if (err) return console.log(err)
  
    console.log(post)

    //Si quiero mandar llamar al ID 3
    findPostById(3,(err,post)=>{
      if (err) return console.log(err)
  
      console.log(post)

      //Si quiero mandar llamar al ID 4, PERO FALLARÁ. porque no existe
...
//imagina que el ID 1 lo necesitas concatecano con el ID 2, luego en el 3 y en el 4
//recuerda que estos datos deben de pintarse en nuestro sitio web, no en la consola
//
